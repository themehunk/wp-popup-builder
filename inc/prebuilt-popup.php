...
<!-- prebuilt popup section -->
		...
		<div class="prebulilt-popup-inner">
			<ul>
				<li data-layout="layout-1">one column</li>
				<li data-layout="layout-2">left image</li>
				<li data-layout="layout-3">right image</li>
			</ul>
		</div>
</div>
<!-- popup name  -->
<div class="wppb-popup-name">
	<div>
		<span>Please Enter Popup name</span>
		<input type="text" name="wppb-popup-name">
		<button class="wppb-popup-name-init">SAVE</button>
	</div>
</div>
<!-- popup name  -->
